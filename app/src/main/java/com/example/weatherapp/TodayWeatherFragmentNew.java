...
public class TodayWeatherFragmentNew extends Fragment {
    ...
    static TodayWeatherFragmentNew instance;

    public static TodayWeatherFragmentNew getInstance() {
        if(instance == null){
            instance = new TodayWeatherFragmentNew();
        }
        return instance;
    }


    public TodayWeatherFragmentNew() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemView =  inflater.inflate(R.layout.fragment_today_weather_new, container, false);
